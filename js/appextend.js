...
var app = {
    ...
    layout: {
        ...
        controls: function() {
            ...
            n.length > 0 && app._controlPanelEvent(n, e, "page-aside-animation-show", "page-aside--minimized", !1, app.settings.breakpoints.md, "group1", $("#content")), t.length > 0 && app._controlPanelEvent(t, e, "page-aside-animation-show", "page-aside--hidden", $("#content"), app.settings.breakpoints.md, "group1"), i.length > 0 && app._controlPanelEvent(i, a, "page-sidepanel-animation-show", "page-sidepanel--hidden", $("#content"), app.settings.breakpoints.xl, "group2"), o && o.click(function(e) {
        ...
        aside_fixed: function() {
            ...
            e.hasClass("page__content--w-aside-fixed") && $(window).on("scroll", app._debouncer(function() {
                var a = 0;
                $(".page__header").length > 0 && (a += app.settings.headerHeight), $(".page__container").length > 0 && (a += app.settings.containerHeight), window.pageYOffset > a ? e.addClass("page-aside-scrolled") : e.removeClass("page-aside-scrolled"), $(".page-aside > .scroll").length > 0 && setTimeout(function() {
    ...
    navigation_detect_auto: function() {
        if (app.settings.navigation.detectAuto) {
            var e = window.location.pathname.split("/"),
                a = e[e.length - 1];
            a = "" !== a ? a : "index.html", $(".navigation a[href='" + a + "']").parent("li").addClass("active").parents(".openable").addClass("open active")
        }
    },
            ...
            e.find("a").each(function() {
                $(this).click(function(a) {
                    ...
                    if ($(this).next().is("UL")) {
                        a.preventDefault();
                        var i = $(this).parent();
                        if (i.hasClass("open")) return i.removeClass("open"), !1;
                        if (app.settings.navigation.closeOther) {
                            var o = $(this).parents("li");
                            $(this).parents("ul").find("> li").not(o).removeClass("open")
                        }
                        return i.addClass("open"), app.settings.responsiveState = !0, app._crt(), i.trigger("mouseenter"), !1
                    }
                })
        ...
        $(".file-tree").each(function() {
            $(this).find("li.folder > a").each(function() {
                $(this).click(function(e) {
                    ...
                    var a = $(this).parent(),
                        n = $(this).find(".icon");
                    return a.hasClass("open") ? (a.removeClass("open"), n.length > 0 && (n.removeClass("fa-folder-open-o"), n.addClass("fa-folder-o"))) : (a.addClass("open"), n && (n.removeClass("fa-folder-o"), n.addClass("fa-folder-open-o"))), app._crt(), !1
                })
            })
        })
    },
    card: {
        remove: function(e, a) {
            return e.addClass("fadeOut", "animated"), setTimeout(function() {
                e.remove()
            }, app.settings.animation), "function" == typeof a && a(), app._crt(), !1
        }
    },
            ...
            a.mouseenter(function(n) {
                ...
                if (t.hasClass("page-aside--minimized") || t.hasClass("navigation--minimized")) {
                    var i = $("#page-aside").offsetHeight,
                        o = a.find("UL")[0];
                    if (o) {
                        o.removeClass("height-control"), o.height("auto");
                        var s = i - a.offsetTop,
                            d = a.offsetTop,
                            r = 0,
                            p = 0;
                        s > d ? r = s : (r = d, p = 1), 1 === p && (app.settings.navigation.fixNavAlwaysDropUp ? o.addClass("dropup") : s < o.offsetHeight && o.addClass("dropup")), r - o.offsetHeight < 0 && (o.addClass("height-control"), o.height(r + "px"))
                    }
                }
        ...
        e.each(function() {
            $(this).click(function(e) {
                if (e.preventDefault, a.removeClass(n), $(this).toggleClass("active"), a.offsetWidth, a.hasClass(t)) {
                    if (a.removeClass(t), a.addClass(n), r.removeClass(t), !1 !== i) {
                ...
                } else a.addClass(t, n), r.addClass(t), !1 !== i ? setTimeout(function() {
                    i.children(".loading").length <= 1 && i.removeClass("hideContainerContent"), app._loading.hide(i, app.settings.animation, s)
                }, app.settings.animation) : setTimeout(function() {
                    d.children(".loading").length <= 1 && d.removeClass("hideContainerContent"), app._loading.hide(d, app.settings.animation, s)
                }, app.settings.animation);
                app.settings.responsiveState = !0, app._crt()
            })
        })
    },
    ...
    _crt: function(e) {
        ...
        console.log("crt"), setTimeout(function() {
            app._fireResize()
        }, e)
    },
    _backdrop: {
        show: function(e) {
            var a = $("<div>");
            a.addClass("backdrop"), void 0 !== e && a.addClass("backdrop--mtransparent"), $("body").append(a)
        },
        hide: function() {
            var e = $("body").find(".backdrop");
            e.addClass("fadeOut"), setTimeout(function() {
                e.remove()
            }, app.settings.animation)
        }
    },
        ...
        show: function(e, a) {
            ...
            if ("object" == typeof a && (void 0 !== a.spinner && !0 === a.spinner && (n.push("loading--w-spinner"), o = !0), void 0 !== a.dark && !0 === a.dark && n.push("loading--dark"), void 0 !== a.text && a.text.length > 0 && (n.push("loading--text"), i = a.text), void 0 !== a.solid && !0 === a.solid && n.push("loading--solid"), void 0 !== a.id && (t = a.id)), e) {
                ...
                var s = $("<div>"),
                    d = $("<div>"),
                    r = $("<div>");
                i && d.html(i), t && s.attr("id", "loading_layer_" + t), o && (r.addClass("loading-spinner"), d.append(r)), (o || i) && s.append(d);
                for (var p = 0; p < n.length; p++) s.addClass(n[p]);
                e.hasClass("preloading") && (e.addClass("loaded"), setTimeout(function() {
                    e.removeClass("preloading", "loaded")
                }, app.settings.animation)), e.append(s)
            }
        },
        hide: function(e, a, n) {
            e && (void 0 === a && (a = 0), setTimeout(function() {
                ...
                a.length > 0 && a.each(function() {
                    ...
                    void 0 !== t.attr("id") && t.attr("id") !== "loading_layer_" + n || (t.addClass("fadeOut"), setTimeout(function() {
                        t.remove(), a.length - 1 == 0 && e.removeClass("loading-process")
                    }, app.settings.animation))
                })
            }, a))
        }
        ...
        show: function(e) {
            ...
            if (n.classList.add("page-loader"), "object" == typeof e) {
                if (void 0 !== e.logo) {
                    ...
                    t.classList.add("logo-holder", "logo-holder--xl"), "boolean" == typeof e.logo ? t.innerHTML = app.settings.logo : t.innerHTML = e.logo, void 0 !== e.logoAnimate && ("boolean" == typeof e.logoAnimate ? t.classList.add("zoomIn", "animated") : t.classList.add(e.logoAnimate, "animated")), n.appendChild(t)
                }
                if (void 0 !== e.spinner) {
                    var i = document.createElement("div");
                    i.classList.add("page-loader__spinner"), n.appendChild(i)
                }
                void 0 !== e.animation && ("boolean" == typeof e.animation ? n.classList.add("page-loader--animation") : n.classList.add(e.animation))
            }
            a.classList.add("page-loading"), a.appendChild(n)
        },
        hide: function() {
            var e = document.body;
            e.querySelector(".page-loader").classList.add("fadeOut"), setTimeout(function() {
                e.classList.remove("page-loading"), $(e).find(".page-loader").remove()
            }, app.settings.animation)
        }
    },
    _backToTop: function() {
        ...
        e.classList.add("back_to_top"), e.addEventListener("click", function() {
            window.scroll({
                top: 0,
                left: 0,
                behavior: "smooth"
            })
        }), document.body.appendChild(e), window.addEventListener("scroll", function() {
            window.pageYOffset > app.settings.backToTopHeight ? e.classList.add("show") : e.classList.remove("show")
        })
    },
    _rwProgress: function() {
        $(".rw-progress").each(function(e, a) {
            var n = a.dataset.value;
            if (n) {
                for (var t = Math.round(n / 10), i = 0; i <= 9; i++) {
                    var o = document.createElement("div");
                    i < t && o.classList.add("active"), a.appendChild(o)
                }
    ...
    _rwAccordion: function() {
        $(".rw-accordion").each(function() {
            $(this).find(".rw-accordion__item").each(function() {
                var e = $(this);
                e.find(".rw-accordion__header").on("click", function() {
                    e.toggleClass("open")
                })
            })
        })
    ...
    _rwCompactGallery: {
        init: function() {
            this.controlHeight(), $(".rw-compact-gallery").on("click", "> li:first", function() {
                var e = $(this).parents(".rw-compact-gallery");
                $(this).appendTo(e)
            })
        },
        controlHeight: function() {
            $(".rw-compact-gallery").each(function() {
                var e = $(this).find("> li:first");
                $(this).height(Math.round(app._getTotalHeight(e.children())))
            })
        }
    },
    ...
    run: function() {
        app.layout.controls(), app.layout.aside_fixed(), app.layout.fixed_panel(), app.layout.responsive(), app.navigation_detect_auto(), app.navigation_quick_build("navigation-quick", "rw-"), app.navigation(), app.file_tree(), app.header_search(), app._backToTop(), app._rwProgress(), app._rwAccordion(), app._rwCompactGallery.init()
    }
};
document.addEventListener("DOMContentLoaded", function() {
    app.run()
}), window.addEventListener("resize", function() {
    app.layout.responsive(), app._rwCompactGallery.controlHeight()
}, !0);